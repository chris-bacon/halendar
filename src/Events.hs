...
handleEvent c (VtyEvent (EvKey (KChar 'r') [])) = continue Calendar { currentYear = currentYear c , currentMonth = currentMonth c , currentDay = currentDay c , focusedDay = currentDay c }
